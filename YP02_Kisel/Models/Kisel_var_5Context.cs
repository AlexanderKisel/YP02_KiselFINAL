...
{
    public partial class Kisel_var_5Context : DbContext
    {
        public Kisel_var_5Context()
        {
        }

        public Kisel_var_5Context(DbContextOptions<Kisel_var_5Context> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<Autorization> Autorizations { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=gogs.wsr.ru;Initial Catalog=Kisel_var_5;User ID=284-20;Password=3W2G57fb;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
            }
        }
